...
Bin size does not only affect sorting, however -- it also reaches the spreading and adding steps downstream. Because points keep an arbitrary order inside a bin, a subproblem's writes are scattered over the whole footprint of the bin it is drawing from, $16 b_x b_y$ bytes at one complex double per cell. While that footprint fits in a core's private L2 the scatter is free, and Table~\ref{tab:spread_l2} shows spreading flat over a four-thousandfold range of bin volume; once the footprint approaches L2 the cost rises steeply, together with the L2 misses that cause it.

Finally, bin size sets the size of the subgrids, through the formulas already derived in \eqref{eq:subgrid_1d}, \eqref{eq:subgrid_2d} and \eqref{eq:subgrid_3d}, where it enters as $b$ along the single axis in one dimension and as $b_x$, $b_y$ and $b_z$ in two and three. Larger bins make larger subgrids, and \texttt{add\_wrapped\_subgrid} has to write out every cell of one, so adding slows down accordingly. Table~\ref{tab:binsize_subgrid} confirms both halves of this: the measured mean subgrid area follows \eqref{eq:subgrid_2d} across the range, and adding costs a constant number of cycles per subgrid cell, so its growth is entirely the growth of the subgrids. The growth is much slower than that of the bins themselves, since the reach of a subproblem along $x$ shrinks as $b_y$ grows and partly cancels it.
...
\begin{table}[h]
    ...
    \begin{subtable}[t]{0.30\textwidth}
        ...
        \begin{tabular}{rrrr}
            \hline
            bin & $n_{\mathrm{bins}}$ & /L1d & [ms] \\
            \hline
            $4\times1$ & 8.4M & 683 & 305 \\
            $8\times2$ & 2.1M & 171 & 169 \\
            $16\times4$ & 526k & 42.8 & 63 \\
            $32\times8$ & 132k & 10.7 & 47 \\
            $48\times12$ & 58k & 4.8 & 38 \\
            $64\times16$ & 33k & 2.7 & 26 \\
            $96\times24$ & 15k & 1.2 & 19 \\
            $128\times32$ & 8372 & 0.7 & 19 \\
            $192\times48$ & 3751 & 0.3 & 23 \\
            $256\times64$ & 2093 & 0.2 & 17 \\
            $384\times96$ & 976 & 0.08 & 21 \\
            $512\times128$ & 552 & 0.05 & 18 \\
            $768\times192$ & 248 & 0.02 & 22 \\
            $1024\times256$ & 138 & 0.01 & 17 \\
            \hline
        \end{tabular}
        \caption{Sorting: the per-thread count array against L1d, and the sort time.}
    ...
    \begin{subtable}[t]{0.29\textwidth}
        ...
        \begin{tabular}{rrrr}
            ...
            bin & /L2 & Gcyc & L2 miss \\
            \hline
            $4\times1$ & 0.00 & 3.41 & 0.044 \\
            $8\times2$ & 0.00 & 3.42 & 0.035 \\
            $16\times4$ & 0.00 & 3.24 & 0.039 \\
            $32\times8$ & 0.00 & 3.24 & 0.033 \\
            $48\times12$ & 0.01 & 3.13 & 0.031 \\
            $64\times16$ & 0.01 & 3.26 & 0.030 \\
            $96\times24$ & 0.03 & 3.18 & 0.029 \\
            $128\times32$ & 0.05 & 3.47 & 0.028 \\
            $192\times48$ & 0.11 & 3.67 & 0.029 \\
            $256\times64$ & 0.20 & 3.88 & 0.031 \\
            $384\times96$ & 0.45 & 4.13 & 0.033 \\
            $512\times128$ & 0.80 & 4.77 & 0.065 \\
            $768\times192$ & 1.80 & 7.59 & 0.318 \\
            $1024\times256$ & 3.20 & 16.64 & 0.497 \\
            \hline
        \end{tabular}
        \caption{Spreading: the bin footprint $16 b_x b_y$ against L2, cycles, and L2 line fills [$10^9$].}
        \label{tab:spread_l2}
    \end{subtable}
    \hfill
    \begin{subtable}[t]{0.37\textwidth}
        ...
        \begin{tabular}{rrrrr}
            \hline
            bin & subgrid & predicted & Gcyc & cyc/cell \\
            \hline
            $4\times1$ & 146k & 147k & 2.68 & 54.5 \\
            $8\times2$ & 152k & 152k & 2.95 & 57.6 \\
            $16\times4$ & 164k & 164k & 3.02 & 54.8 \\
            $32\times8$ & 187k & 187k & 3.50 & 55.7 \\
            $48\times12$ & 210k & 210k & 3.91 & 55.4 \\
            $64\times16$ & 233k & 234k & 4.70 & 59.9 \\
            $96\times24$ & 266k & 267k & 4.98 & 55.7 \\
            $128\times32$ & 280k & 281k & 5.31 & 56.4 \\
            $192\times48$ & 294k & 295k & 5.26 & 53.3 \\
            $256\times64$ & 304k & 306k & 5.44 & 53.3 \\
            $384\times96$ & 325k & 329k & 5.75 & 52.6 \\
            $512\times128$ & 353k & 358k & 6.13 & 51.8 \\
            $768\times192$ & 428k & 439k & 7.90 & 55.0 \\
            $1024\times256$ & 526k & 552k & 10.16 & 57.5 \\
            \hline
        \end{tabular}
        \caption{Adding: mean subgrid area measured and predicted, cycles, and cycles per cell.}
