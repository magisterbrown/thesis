...
\begin{table}[h]
    ...
    \begin{tabular}{|l|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{Geometric-mean speedup of the cache-aware \texttt{auto} heuristic (at its deployed setting, $\text{CACHE\_FRAC}=0.25$) over the fixed legacy default $S_{\max}=10^5$, for $M=4\times10^8$, averaged over $T\in\{11,13,16,20,25,32,64\}$.}
